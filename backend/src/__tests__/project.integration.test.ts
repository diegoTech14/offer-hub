...
describe('assignFreelancerHandler Integration Tests', () => {
  ...
  describe('Success Scenarios', () => {
    it('should successfully assign freelancer and return 200 with updated project', async () => {
      ...
      const mockFn = projectService.assignFreelancer as jest.MockedFunction<typeof projectService.assignFreelancer>;
      ...
      await assignFreelancerHandler(mockRequest as Request, mockResponse as Response);
  ...
  describe('Error Scenarios', () => {
    ...
    it('should return 404 when project is not found', async () => {
      ...
      (projectService.assignFreelancer as jest.Mock).mockResolvedValue(serviceResult);
