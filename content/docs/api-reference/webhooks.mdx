...
Webhooks let your application receive real-time notifications when events occur in OFFER-HUB — order updates, balance credits, escrow state changes, and more.
